...
<table class= 'Wtable'>
   ...
   <tr title="Date" style = "background-color : rgb(213, 235, 217)">
   ...
   <tr title = "Min and Max Temperature" style="background-color : white">
      <td style="border-right:3px solid rgb(255, 228, 3);border-left:3px solid rgb(255, 228, 3)"><span class="material-icons">thermostat</span> {round(min_temp[0])}°C - {round(max_temp[0])}°C </td>
